...
function NotificationsPage() {
  ...
  const renderNotificationIcon = (type: NotificationProps['type']) => {
    switch (type) {
      case 'like':
  ...
  const renderNotificationContent = (notification: NotificationProps) => {
  ...
  const renderRelatedPost = (relatedPost: NotificationProps['relatedPost']) => {
